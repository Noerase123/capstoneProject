...
public class DragNDrop3 : MonoBehaviour {
    ...
    public void Drag6()
    {
        GameObject.Find("Drag6").transform.position = Input.mousePosition;
        print("Sais");
    }

    public void Drag7()
    {
        GameObject.Find("Drag7").transform.position = Input.mousePosition;
        print("Siete");
    }
    ...
    public void Drop6()
    {
        ...
        {
            GameObject ph1 = GameObject.Find("PlaceHolder" + i);
            float distance = Vector3.Distance(GameObject.Find("Drag6").transform.position, ph1.transform.position);
            print("Distance" + distance);
            if (distance < 75)
            {
                if (ph1.tag == "match6")
                {
                    GameObject.Find("Drag6").transform.position = ph1.transform.position;
                   
                    drag6.SetActive(false);
                    six.SetActive(false);
                    check6.SetActive(true);
                    drag5.SetActive(true);
    ...
    public void Drop7()
    {
        ...
        {
            GameObject ph1 = GameObject.Find("PlaceHolder" + i);
            float distance = Vector3.Distance(GameObject.Find("Drag7").transform.position, ph1.transform.position);
            print("Distance" + distance);
            if (distance < 75)
            {
                if (ph1.tag == "match7")
                {
                    GameObject.Find("Drag7").transform.position = ph1.transform.position;
                    
                    drag7.SetActive(false);
                    seven.SetActive(false);
                    check7.SetActive(true);
                    drag6.SetActive(true);
